        ...
        <form action="{{ route('lokasi.update', $lokasi->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <input id="nama_kampung" type="text" class="form-control @error('nama_kampung') is-invalid @enderror" name="nama_kampung" value="{{ $lokasi->nama_kampung }}" autocomplete="nama_kampung">
                ...
                <div class="col-lg-6">
                    ...
                    <input id="nama_kecamatan" type="text" class="form-control @error('nama_kecamatan') is-invalid @enderror" name="nama_kecamatan" value="{{ $lokasi->nama_kecamatan }}" autocomplete="nama_kecamatan">
