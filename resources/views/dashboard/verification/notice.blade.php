<head>
  ...
  <div style="margin:0px auto;max-width:640px;background:transparent;"><table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:transparent;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:40px 0px;"><!--[if mso | IE]>
        ...
        <![endif]--><div style="cursor:auto;color:white;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:36px;font-weight:600;line-height:36px;text-align:center;">Selamat, Akun Anda Berhasil dibuat</div><!--[if mso | IE]>
        </td></tr></table>
  ...
  <p>Pembuatan akun anda telah berhasil dilakukan, selanjutnya silahkan periksa alamat email anda untuk melakukan proses verifikasi alamat Email yang telah anda daftarkan sebelumnya.</p>
